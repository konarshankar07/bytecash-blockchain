...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Bytecash-darwin-arm64/Bytecash.app --platform=darwin \
...
mv Bytecash-darwin-arm64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Bytecash-$CHIA_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Bytecash-darwin-arm64/Bytecash.app Bytecash-$CHIA_INSTALLER_VERSION-arm64 \
