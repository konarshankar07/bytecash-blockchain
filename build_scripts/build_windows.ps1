...
Write-Output "Bytecash Version is: $env:CHIA_INSTALLER_VERSION"
Write-Output "   ---"
...
Write-Output "   ---"
Write-Output "Build bytecash-blockchain wheels"
Write-Output "   ---"
pip wheel --use-pep517 --extra-index-url https://pypi.chia.net/simple/ -f . --wheel-dir=.\build_scripts\win_build .

Write-Output "   ---"
Write-Output "Install bytecash-blockchain wheels into venv with pip"
Write-Output "   ---"
...
Write-Output "pip install bytecash-blockchain"
pip install --no-index --find-links=.\win_build\ bytecash-blockchain

Write-Output "   ---"
Write-Output "Use pyinstaller to create bytecash .exe's"
Write-Output "   ---"
$SPEC_FILE = (python -c 'import bytecash; print(bytecash.PYINSTALLER_SPEC_PATH)') -join "`n"
pyinstaller --log-level INFO $SPEC_FILE

Write-Output "   ---"
Write-Output "Copy bytecash executables to bytecash-blockchain-gui\"
Write-Output "   ---"
Copy-Item "dist\daemon" -Destination "..\bytecash-blockchain-gui\" -Recurse
Set-Location -Path "..\bytecash-blockchain-gui" -PassThru
...
Write-Output "   ---"
Write-Output "Increase the stack for bytecash command for (bytecash plots create) chiapos limitations"
# editbin.exe needs to be in the path
editbin.exe /STACK:8000000 daemon\bytecash.exe
Write-Output "   ---"

$packageVersion = "$env:CHIA_INSTALLER_VERSION"
$packageName = "Bytecash-$packageVersion"
...
electron-packager . Bytecash --asar.unpack="**\daemon\**" --overwrite --icon=.\src\assets\img\bytecash.ico --app-version=$packageVersion
Write-Output "   ---"
