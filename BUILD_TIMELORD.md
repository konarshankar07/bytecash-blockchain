...
required to run a [Timelord](https://github.com/Bytecash-Network/bytecash-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Bytecash-Network/bytecash-blockchain/blob/main/install-timelord.sh)
