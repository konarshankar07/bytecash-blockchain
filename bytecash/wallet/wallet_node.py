...
from bytecash.daemon.keychain_proxy import (
    KeychainProxy,
...
from bytecash.pools.pool_puzzles import SINGLETON_LAUNCHER_HASH
from bytecash.protocols import wallet_protocol
from bytecash.protocols.full_node_protocol import RequestProofOfWeight, RespondProofOfWeight
from bytecash.protocols.protocol_message_types import ProtocolMessageTypes
from bytecash.protocols.wallet_protocol import (
...
from bytecash.server.node_discovery import WalletPeers
...
from bytecash.util.config import WALLET_PEERS_PATH_KEY_DEPRECATED, load_config
from bytecash.util.errors import Err, ValidationError
from bytecash.util.ints import uint32, uint128
from bytecash.util.keychain import Keychain
from bytecash.util.lru_cache import LRUCache
from bytecash.util.merkle_set import MerkleSet, confirm_included_already_hashed, confirm_not_included_already_hashed
from bytecash.util.network import get_host_addr
...
from bytecash.wallet.wallet_blockchain import ReceiveBlockResult
...
class WalletNode:
    ...
    async def get_key_for_fingerprint(self, fingerprint: Optional[int]) -> Optional[PrivateKey]:
        ...
        try:
            ...
            self.log.warning("No keys present. Create keys with the UI, or with the 'bytecash keys' program.")
            return None
