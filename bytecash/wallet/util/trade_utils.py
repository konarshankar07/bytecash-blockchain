...
from bytecash.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "bytecash" in cc_discrepancies:
                    cc_discrepancies["bytecash"] = cc_discrepancies["bytecash"] + diff
                else:
                    cc_discrepancies["bytecash"] = diff
