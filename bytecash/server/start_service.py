...
from bytecash.daemon.server import singleton, service_launch_lock_path
from bytecash.server.ssl_context import bytecash_ssl_ca_paths, private_ssl_ca_paths
...
class Service:
    def __init__(
        ...
        proctitle_name = f"bytecash_{service_name}"
        ...
        bytecash_ca_crt, bytecash_ca_key = bytecash_ssl_ca_paths(root_path, self.config)
        ...
        self._server = ChiaServer(
            ...
            (bytecash_ca_crt, bytecash_ca_key),
