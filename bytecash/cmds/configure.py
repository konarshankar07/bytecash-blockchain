...
from bytecash.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "58444"
            testnet_introducer = "beta1_introducer.bytecash.net"
            testnet_dns_introducer = "dns-introducer-testnet7.bytecash.net"
            testnet = "testnet7"
            ...
            mainnet_port = "8444"
            mainnet_introducer = "introducer.bytecash.net"
            mainnet_dns_introducer = "dns-introducer.bytecash.net"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running bytecash services for changes to take effect")
