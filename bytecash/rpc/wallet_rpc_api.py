...
from bytecash.consensus.block_rewards import calculate_base_farmer_reward
from bytecash.pools.pool_wallet import PoolWallet
from bytecash.pools.pool_wallet_info import create_pool_state, FARMING_TO_POOL, PoolWalletInfo, PoolState
from bytecash.protocols.protocol_message_types import ProtocolMessageTypes
from bytecash.server.outbound_message import NodeType, make_msg
...
from bytecash.util.bech32m import decode_puzzle_hash, encode_puzzle_hash
from bytecash.util.byte_types import hexstr_to_bytes
from bytecash.util.ints import uint32, uint64
from bytecash.util.keychain import KeyringIsLocked, bytes_to_mnemonic, generate_mnemonic
from bytecash.util.path import path_from_root
from bytecash.util.ws_message import WsRpcMessage, create_payload_dict
...
from bytecash.wallet.derive_keys import master_sk_to_farmer_sk, master_sk_to_pool_sk, master_sk_to_wallet_sk
...
from bytecash.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from bytecash.wallet.util.trade_utils import trade_record_to_dict
...
from bytecash.wallet.wallet_info import WalletInfo
from bytecash.wallet.wallet_node import WalletNode
...
class WalletRpcApi:
    def __init__(self, wallet_node: WalletNode):
        ...
        self.service_name = "bytecash_wallet"
    ...
    async def _state_changed(self, *args) -> List[WsRpcMessage]:
        ...
        return [create_payload_dict("state_changed", data, "bytecash_wallet", "wallet_ui")]
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from bytecash.pools.pool_wallet_info import initial_pool_state_from_dict
