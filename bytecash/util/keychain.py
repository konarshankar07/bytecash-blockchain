...
DEFAULT_USER = f"user-bytecash-{CURRENT_KEY_VERSION}"  # e.g. user-bytecash-1.8
DEFAULT_SERVICE = f"bytecash-{DEFAULT_USER}"  # e.g. bytecash-user-bytecash-1.8
...
def obtain_current_passphrase(prompt: str = DEFAULT_PASSPHRASE_PROMPT, use_passphrase_cache: bool = False) -> str:
    ...
    before failing.
    """
    from bytecash.cmds.passphrase_funcs import prompt_for_passphrase
