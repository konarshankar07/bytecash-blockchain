...
from bytecash.consensus.network_type import NetworkType
from bytecash.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from bytecash.farmer.farmer import Farmer
from bytecash.protocols import farmer_protocol, harvester_protocol
from bytecash.protocols.harvester_protocol import PoolDifficulty
...
from bytecash.util.api_decorators import api_request, peer_required
                ...
                try:
                    async with aiohttp.ClientSession() as session:
                        async with session.post(
                            ...
                            headers={"User-Agent": f"Bytecash Blockchain v.{__version__}"},
                        ) as resp:
                            if resp.ok:
