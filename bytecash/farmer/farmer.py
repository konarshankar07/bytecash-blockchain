...
from bytecash.pools.pool_config import PoolWalletConfig, load_pool_config
from bytecash.protocols import farmer_protocol, harvester_protocol
from bytecash.protocols.pool_protocol import (
    ErrorResponse,
...
from bytecash.server.server import ssl_context_for_root
...
from bytecash.util.bech32m import decode_puzzle_hash
from bytecash.util.byte_types import hexstr_to_bytes
from bytecash.util.config import load_config, save_config, config_path_for_filename
from bytecash.util.hash import std_hash
from bytecash.util.ints import uint8, uint16, uint32, uint64
...
from bytecash.wallet.puzzles.singleton_top_layer import SINGLETON_MOD
...
class Farmer:
    ...
    async def setup_keys(self):
        ...
        if len(self.get_public_keys()) == 0:
            error_str = "No keys exist. Please run 'bytecash keys generate' or open the UI."
