"""
NOTE: This contains duplicate code from `bytecash.cmds.plots`.
After `bytecash plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Bytecash Proof of Space", "version": chiapos_version, "installed": True}
