...
from bytecash.plotters.bladebit import get_bladebit_install_info, plot_bladebit
from bytecash.plotters.chiapos import get_chiapos_install_info, plot_chia
from bytecash.plotters.madmax import get_madmax_install_info, plot_madmax
from bytecash.plotters.install_plotter import install_plotter
...
def call_plotters(root_path: Path, args):
    ...
    build_parser(subparsers, root_path, bytecash_plotter, "chiapos", "Chiapos Plotter")
    ...
    if args.plotter == "chiapos":
        plot_chia(args, bytecash_root_path)
    if args.plotter == "madmax":
        plot_madmax(args, bytecash_root_path, root_path)
    if args.plotter == "bladebit":
        plot_bladebit(args, bytecash_root_path, root_path)
