...
from bytecash.types.blockchain_format.foliage import Foliage, FoliageTransactionBlock, TransactionsInfo
...
from bytecash.types.blockchain_format.vdf import VDFProof
