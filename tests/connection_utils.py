...
async def add_dummy_connection(
    ...
    generate_ca_signed_cert(
        server.bytecash_ca_crt_path.read_bytes(), server.bytecash_ca_key_path.read_bytes(), dummy_crt_path, dummy_key_path
    )
    ssl_context = ssl_context_for_client(
        server.bytecash_ca_crt_path, server.bytecash_ca_key_path, dummy_crt_path, dummy_key_path
    )
