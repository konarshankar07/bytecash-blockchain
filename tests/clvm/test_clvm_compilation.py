...
wallet_program_files = set(
    [
        "bytecash/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "bytecash/wallet/puzzles/cc.clvm",
        "bytecash/wallet/puzzles/chialisp_deserialisation.clvm",
        "bytecash/wallet/puzzles/rom_bootstrap_generator.clvm",
        "bytecash/wallet/puzzles/generator_for_single_coin.clvm",
        "bytecash/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "bytecash/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "bytecash/wallet/puzzles/lock.inner.puzzle.clvm",
        "bytecash/wallet/puzzles/p2_conditions.clvm",
        "bytecash/wallet/puzzles/p2_delegated_conditions.clvm",
        "bytecash/wallet/puzzles/p2_delegated_puzzle.clvm",
        "bytecash/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "bytecash/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "bytecash/wallet/puzzles/p2_puzzle_hash.clvm",
        "bytecash/wallet/puzzles/rl_aggregation.clvm",
        "bytecash/wallet/puzzles/rl.clvm",
        "bytecash/wallet/puzzles/sha256tree_module.clvm",
        "bytecash/wallet/puzzles/singleton_top_layer.clvm",
        "bytecash/wallet/puzzles/did_innerpuz.clvm",
        "bytecash/wallet/puzzles/decompress_puzzle.clvm",
        "bytecash/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "bytecash/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "bytecash/wallet/puzzles/block_program_zero.clvm",
        "bytecash/wallet/puzzles/test_generator_deserialize.clvm",
        "bytecash/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "bytecash/wallet/puzzles/p2_singleton.clvm",
        "bytecash/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "bytecash/wallet/puzzles/pool_member_innerpuz.clvm",
        "bytecash/wallet/puzzles/singleton_launcher.clvm",
        "bytecash/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["bytecash/wallet/puzzles/create-lock-puzzlehash.clvm", "bytecash/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "bytecash/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to bytecash/wallet/puzzles, but not added to `wallet_program_files`
        """
