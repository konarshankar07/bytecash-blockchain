...
from bytecash.pools.pool_config import PoolWalletConfig
from bytecash.util.config import load_config, save_config, create_default_bytecash_config
...
def test_pool_config():
    ...
    create_default_bytecash_config(test_root, ["config.yaml"])
